...
export default function Services() {
  ...
  <Link
    ...
    className="group block w-full overflow-hidden rounded-[28px] border border-white/10 p-4 shadow-lg transition-all duration-300 hover:-translate-y-1 active:scale-[0.99] active:border-white/20"
    style={{
            ...
            <div className="flex w-max gap-4 animate-[services-marquee_28s_linear_infinite] group-hover:[animation-play-state:paused]">
              {[...marqueeServices, ...marqueeServices].map((service, index) => (
                <article
                  ...
                  className="group/item relative shrink-0 w-[72vw] min-w-[72vw] max-w-[72vw] sm:w-[17rem] sm:min-w-[17rem] sm:max-w-[17rem] lg:w-[19vw] lg:min-w-[11rem] lg:max-w-[14.5rem] overflow-hidden rounded-2xl border border-white/10"
